...
function displayVideo(url: string){
    var preview = <HTMLCanvasElement>document.getElementById("preview");
    var videoHolder = <HTMLVideoElement>document.getElementById("video-holder");
